    ...
    def save_rgb(self, file_name: str, rgb_option: int):
        ...
        if rgb_option == 1: # To store only Red channels
            for y in range(self.height):
                ...
                for x in range(self.width):
                    raw_data.append(self.img[y][x][0]) # Only get the R value from img, set G & B to 0
                    raw_data.append(0)
                    raw_data.append(0)
            ...
            for y in range(self.height):
                ...
                for x in range(self.width):
                    raw_data.append(0)
                    raw_data.append(self.img[y][x][1]) # Only get the G value from img, set R & B to 0
                    raw_data.append(0)
            ...
            for y in range(self.height):
                ...
                for x in range(self.width):
                    raw_data.append(0)
                    raw_data.append(0)
                    raw_data.append(self.img[y][x][2]) # Only get the B value from img, set R & G to 0

        
        rgb_compressed_idat_data = zlib.compress(bytes(raw_data))
