...
class PNG:
    ...
    def save_rgb(self, file_name: str, rgb_option: int):
        ...
        with open(file_name, 'wb') as file:
            ...
            file.write(ihdr_chunk[0])
            file.write(ihdr_chunk[1])
            file.write(ihdr_chunk[2])
            file.write(ihdr_chunk[3])
            ...
            file.write(iend_chunk[0])
            file.write(iend_chunk[1])
            file.write(iend_chunk[2])
            file.write(iend_chunk[3])
